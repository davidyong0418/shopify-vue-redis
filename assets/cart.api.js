...
Shopify.cartUpdateInfo = function(cart, cart_cell_id) {
  var discount_item_count = 0;
  cart.items = cart.items.filter(function (i) {
    if (i.product_type === 'discount') {
      discount_item_count += i.quantity;
    }
    return i.product_type !== 'discount';
  });
  cart.item_count = cart.item_count - discount_item_count;
